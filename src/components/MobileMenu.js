...
export function MobileMenu({ isMenuOpen, onMenuClose }) {
  return (
    <>
      ...
      <div
        className={`border-t-2 border-gray-300 z-20 xl:hidden fixed top-[96px] md:top-[105px] right-0 bottom-0 min-h-screen bg-[#FCFCF7]  w-3/4 transition-transform duration-300 px-6 pb-32 pt-3 flex flex-col items-end gap-10 overflow-auto ${isMenuOpen ? ' translate-x-0' : ' translate-x-full'}`}
      >
